...
router.get('/company/all', verifyCompany, ensureMongoConnection, async (req, res) => {
  try {
...
router.get('/company/transactions/all', verifyCompany, ensureMongoConnection, async (req, res) => {
  try {
    const companyId = req.user.id;
