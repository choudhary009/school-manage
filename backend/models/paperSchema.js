...
const paperSchema = new mongoose.Schema(
  {
    ...
    paperType: {
      type: String,
      enum: ["monthly", "weekly", "assignment", "midterm", "final", "classTest"], // Valid options
      required: true,
    },
    totalMarks: {
      type: Number,
    ...
    questions: [
      {
        q: { type: String },
        space: { type: Number },
        qImage: { type: String }, // Base64 or URL for question image
        qType: { type: String, enum: ["standard", "column"], default: "standard" },
        column1: [{ type: String }], // Array of strings for matching column A
        column2: [{ type: String }], // Array of strings for matching column B
      },
    ],
  },
  { timestamps: true }
