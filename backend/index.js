...
// Force Node's DNS resolver to use public DNS so that Atlas `mongodb+srv://`
// SRV/TXT lookups work even when the local router/ISP resolver misbehaves.
try {
...
app.listen(PORT, () => {
  ...
  console.log("Auth routes: POST /UnifiedLogin | POST /unifiedlogin (single email login)");
});
